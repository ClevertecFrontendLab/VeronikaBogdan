import { Avatar, Flex, Grid, GridItem, Image, Spacer, useOutsideClick } from '@chakra-ui/react';
...
const Header = () => {
    ...
    useOutsideClick({
        ref: menuRef,
        handler: () => dispatch(setBurgerMenuState(false)),
    });
        ...
        <>
            ...
            >
                ...
                <Image
                    ...
                    hideFrom='xl'
                    onClick={() => dispatch(setBurgerMenuState(!isBurgerMenu))}
                />
                {isBurgerMenu && <NavigationMenu />}
            </Flex>
        </>
    );
};
